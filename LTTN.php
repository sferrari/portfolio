...
?>
    ...
    <div class="container">
      ...
      <div>
        <a class="btn btn-outline-primary btn-sm" style="margin-bottom:15px;" href="https://sferrari.net/LTTN/prototype/lttn_homepage.html">View the Prototype</a>
      </div>
        ...
        <div class="card card4 text-white bg-primary">
          ...
          <p class="card-text">To make an app or service that helps connect neighbors and benefits neighborhoods.</p>
          </div>
        </div>
        ...
        <div class="card card4 text-white bg-primary">
          ...
          <p class="card-text">Ideation, competitive analysis, sketching, storyboarding, personas, prototyping.</p>
          </div>
        </div>

        <div class="card card4 text-white bg-primary">
          <div class="card-body">
          <h4 class="card-title">Tools Used</h4>
          <p class="card-text">Paper and pen, Pages for OS X, NinjaMock, iMovie, Spark for iOS, Axure.</p>
          </div>
        </div>
        ...
        <div class="card card4 text-white bg-primary">
          ...
          <p class="card-text">One semester - Winter 2014<br>
  ...
  <hr>
      <div>
          ...
          <p>The design process for the app went through several round, including:</p>
          ...
          <blockquote><h4>Scenario #1</h4>
          <p>Rohan gets to his office at 8:30 in the morning and has three straight meetings, then lunch, and finally has time to work on his own stuff in the afternoon. Instead of listening to music in the background, he connects his phone to a bluetooth speaker and streams the audio feed of the LTTN app. Upon opening the app, he opts to enter in his home address rather than use his current location at the office. While he is working he can listen to the different tones generated by neighbors as they come and go and perform different activities (texting, running, making and receiving phone calls). Around 2pm he starts to hear a crescendo of activity, with seemingly lots of neighbors arriving back home and this draws his attention, since it’s still early in the day for people to be coming back from home. He texts his roommate and asks him what’s up. Apparently the local elementary school closed early on account of a small fire, though no one was injured. When he gets home, he knocks on his neighbor’s door to see if she and her son are doing ok.</p>
          
          <h4>Scenario #2</h4>
          <p>It’s Saturday afternoon and Sergey is having his usual tea at the senior center. He gets out his iPad and after looking through the news, he opens up LTTN and enters the name of his village, which is only about a 15 minute drive away. From experience he knows that the app will usually be active with lots of sounds on the weekend. But today it’s even more active than usual, and he sees that the neighbors in his village are pinging each other a bunch. Of course! He forgot that today is the championship game of the local football league. Seeing all the activity taking place, he decides to call up a friend from the village who is only a few years younger than him but still has access to his car. He asks if he wouldn't mind picking him up from the senior center so he can make it to the game.</p>
          
          <h4>Scenario #3</h4>
          <p>Julia is working on a project for her performance art class. Seeking inspiration, she goes to her computer and turns on the LTTN app. She likes to do this occasionally, and one of her favorite features is that she can skip around from town to town, and city to city, each of which have their own levels of activity. If she wants to hear an especially cacophonous set of sounds, she can zoom out from a single neighborhood and instead hear the sounds of a whole city. Or she can select a rural area that only has a few users if she would instead like the serenity of a steady but slow drip of sounds. Another favorite feature is the option to switch sets of sounds, so that she can go from a more meditative set to a disco-inspired set to a more skeuomorphic set of sounds. She plays around with these different possibilities until she settles on what that fits both her mood and the tone of her project. Then she listens to the app on her speakers and projects the images on to a wall using a projector that’s connected to her computer. She finds that doing this brings her inspiration as she refines her art project.</p></blockquote>
